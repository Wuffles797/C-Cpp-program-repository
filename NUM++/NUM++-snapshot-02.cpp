...
// And a important "unistd.h" for sleeping
#include <unistd.h>
...
int main (int argc, const char * argv[])
{
	...
	// other historys
	fstream gfile;
	gfile.open("CD_history.txt", ios::in | ios::out | ios::app);
	
	fstream pfile;
	pfile.open("MCM_history.txt", ios::in | ios::out | ios::app);
	
	fstream qfile;
	qfile.open("PO_history.txt", ios::in | ios::out | ios::app);
	
	fstream prfile;
	prfile.open("PR_history.txt", ios::in | ios::out | ios::app); 
	...
	char ori_moul[200] = "[";
	char ori_mour[200] = "]";
	char ori_prod[200] = "wants NUM";
	char ori_timi1[200] = "'s";
	char ori_timi2[200] = "times";
	char ori_prime[200] = "list of prime NUMs small than";
	breaky = 0;
	result = 0;
    ...
    printf("	3)");
    printf("check historys in the path you installed this\n\n");
    ...
    do
    {
        ...
        if (change == 2)
        {
            ...
            do
            {
                ...
                nonsub = subnon(berange, subnon(rangeo, range));
                gfile << nonsub;
                printf(" NUM Result: %d \n", nonsub);
            } while (2 == 2);
        }
        ...
        if (change == 4)
        {
            do
            {
            	...
            	prfile << dt;
            	prfile << ":	";
                printf("give an num to control the nums of what you're listing: ");
                scanf("%ld",&change2);
